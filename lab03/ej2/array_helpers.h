...
// Next, I define a couple of variables that will prove themselves useful for the second excercise of this lab !!!
#define FST_MONTH 1
#define LST_MONTH 12
#define MONTHS 12
// Here ends the variables that I CHOSE to define for obvious reasons.
...
void len_array_dump(int a[], unsigned int length);
